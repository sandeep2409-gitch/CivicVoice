      ...
      <div className="hidden md:flex flex-1 bg-slate-900 relative items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg px-12 text-white">
          ...
          <p className="text-slate-300 text-lg leading-relaxed mb-8">
            Manage reports, verify issues, and coordinate community action from a secure, unified dashboard.
          </p>
          <div className="flex gap-4">
            <Link href="/" className="inline-flex items-center gap-2 text-slate-300 font-semibold hover:text-white transition-colors">
      ...
      {showTutorial && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden relative">
            ...
            <div className="p-8">
              <h2 className="text-2xl font-bold font-serif text-slate-900 mb-4">Admin Features</h2>
              <div className="space-y-4 text-slate-600 text-base leading-relaxed">
                <p><strong>Civic Voice Admin</strong> provides powerful tools for community managers and local authorities.</p>
                <ul className="list-disc pl-5 space-y-2">
                  <li><strong>Unified Dashboard:</strong> View all incoming issues automatically ranked by AI severity and community confirmations.</li>
                  <li><strong>Actionable Insights:</strong> Track resolution rates, categorize incoming reports, and filter by urgency.</li>
                  <li><strong>Direct Resolution:</strong> Mark issues as resolved to keep the community updated on the feed instantly.</li>
                </ul>
                <p className="pt-4">Only authorized personnel can access this portal.</p>
              </div>
              <div className="mt-8">
                <button 
                  onClick={() => setShowTutorial(false)}
